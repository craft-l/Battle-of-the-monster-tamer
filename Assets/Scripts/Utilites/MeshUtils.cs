...
public static class MeshUtils {
	...
	public static void AddToMeshArraysIsometric(Vector3[] vertices, Vector2[] uvs, int[] triangles, int index, Vector3 pos, Vector2 offset, Vector2 uv00, Vector2 uv11) {
		//Relocate vertices
		int vIndex = index*4;
		int vIndex0 = vIndex;
		int vIndex1 = vIndex+1;
		...
		vertices[vIndex1] = pos+new Vector3(offset.x,0, -offset.y);
		vertices[vIndex2] = pos+new Vector3(0,0,-2*offset.y);
		vertices[vIndex3] = pos-new Vector3(offset.x,0,offset.y);
